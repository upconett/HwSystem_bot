...
from handlers.private import commands, default_schedule_upload, group_create, group_enter, \
	homework_show, schedule_show, group_leave, group_delete, group_change_owner, group_members
...
async def main():
	...
	group_delete.register_handlers(router=router_private_groupOwner)
	group_change_owner.register_handlers(router=router_private_groupOwner)
	group_members.register_handlers(router=router_private_groupOwner)
